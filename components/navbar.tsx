...
export function NavBar() {
    ...
    return (
        <nav className="fixed top-0 left-0 w-full bg-white shadow-sm z-50">
            <div className="max-w-7xl mx-auto px-4 py3 flex items-center justify-between">
                <Link href="/">
                    <Image
                        className="text-xl font-bold text-emerald-700 cursor-pointer"
                        src="/logo3.png" width={60} height={60} alt="logo" />
                </Link>
                <div className="space-x-6 flex items-center">
                    <SignedIn>
                        ...
                        >Mealplan</Link>
                        {user?.imageUrl ? (<Link href="/profile"><Image src={user.imageUrl} alt="profile Picture" width={40} height={40}
